...
public class orders {    
private static String[] strs = {"WINDOWS", "MAC OS", "UBUNTU", "LINUX", "KALI OS", "ANDROID", "FEDORA", "CHROME OS", "SOLARIS"};
public enum sort_asc_dsc{
ASC, DESC
}
public static void main(String[] args) {
System.out.println("\nOriginal unsorted OS: " + Arrays.toString(strs));
sort_array_by_length(strs, sort_asc_dsc.DESC);
System.out.println("\nSorted OS (descending order): " + Arrays.toString(strs));
sort_array_by_length(strs, sort_asc_dsc.ASC);
System.out.println("\nSorted OS (ascending order): " + Arrays.toString(strs));            
}
